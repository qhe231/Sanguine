...
<header class="page-header header container-fluid">
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <h2>Username</h2></div>
            <div class="col">${user.userName} <br><br></div>
            <div class="col">  <button onclick="showForm('changeUsername', 'usernameBtn')" id="usernameBtn">Change</button></div>

            <%--Form to change username--%>
            <div class="col"> <div style="display: none" id="changeUsername">
