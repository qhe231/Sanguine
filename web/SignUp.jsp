...
<body>
    <div id="contain">
        <form action="./SignUp" method="post">
            ...
            <input type="description" name="description" value=""> <br>
                ...
                <input type="radio" name="avatar" value="lion" id="lionAvatar">Lion
                <input type="radio" name="avatar" value="monkey" id="monkeyAvatar">Monkey
            <br>
