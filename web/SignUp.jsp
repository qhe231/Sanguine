        ...
        <div id="left">
            ...
            <form action="./SignUp" method="post">
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col"><input type="radio" name="avatar" value="own" class="avatar" id="ownAvatar">
                            <span id="ownAvatarPic">Upload Avatar</span>
                    ...
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col"> <input type="submit" id="submit"> </div>
                    </div>
